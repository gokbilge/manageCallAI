...
const tenantNav: NavItem[] = [
  ...
  { to: '/tenant/integrations/carrier-assistant', label: 'Carrier Assistant', icon: Server, capability: CAPABILITIES.TENANT_SIP_TRUNKS_CREATE },
  ...
  { to: '/tenant/investigations', label: 'Investigations', icon: MessageSquareWarning, capability: CAPABILITIES.TENANT_RISK_ANALYSIS },
  { to: '/tenant/reporting', label: 'Reporting', icon: BarChart2, capability: CAPABILITIES.TENANT_NL_REPORTING },
  { to: '/tenant/contact-center/supervisor', label: 'Supervisor', icon: Users, capability: CAPABILITIES.TENANT_CONTACT_CENTER_VIEW },
  { to: '/tenant/contact-center/wallboard', label: 'Wallboard', icon: Activity, capability: CAPABILITIES.TENANT_CONTACT_CENTER_WALLBOARD_VIEW },
  { to: '/tenant/contact-center/qa', label: 'QA Reviews', icon: ClipboardCheck, capability: CAPABILITIES.TENANT_CONTACT_CENTER_QA_MANAGE },
