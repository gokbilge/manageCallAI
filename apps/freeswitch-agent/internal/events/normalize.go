...
func NormalizeMVP(headers map[string]string, tenantID string) (NormalizedEvent, bool) {
	...
	case "CHANNEL_PARK":
		return fromHeaders("channel_park", headers, tenantID), true
	case "CHANNEL_UNPARK":
		return fromHeaders("channel_unpark", headers, tenantID), true
	case "sofia::register":
		return fromHeaders("registration_seen", headers, tenantID), true
	case "sofia::unregister", "sofia::expire":
		return fromHeaders("registration_expired", headers, tenantID), true
	default:
