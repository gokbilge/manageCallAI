...
- [ADR-0011: Zod Contracts Are the API Contract Source of Truth](0011-zod-contracts-source-of-truth.md)
- [ADR-0012: MCP and Workflow Surfaces Stay Narrower Than REST](0012-mcp-and-workflow-surfaces-narrower-than-rest.md)
- [ADR-0013: Runtime Authentication Is Separate From User Authentication](0013-runtime-auth-model.md)
- [ADR-0014: Publishable Objects Follow a Shared Lifecycle](0014-publishable-object-lifecycle.md)
- [ADR-0015: Lua Is a Thin Runtime Executor](0015-lua-thin-executor-boundary.md)
- [ADR-0016: IVR Graphs Are Business Objects, Not BPMN XML](0016-ivr-graph-not-bpmn-xml.md)
