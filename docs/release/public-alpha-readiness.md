...
- [ ] All high/medium CodeQL alerts closed or triaged.
- [ ] General `/api/v1/*` fallback rate limit verified.
- [ ] Sensitive runtime/SIP logging findings closed.
- [ ] README clearly says alpha and not production-ready.
- [ ] Known limitations are documented.
- [ ] Local alpha deployment doc exists.
- [ ] Local demo loop verified from a clean clone.
- [ ] Runtime proof verified manually on one clean machine.
- [ ] Docker images build successfully.
- [ ] DB migration replay and constraints pass.
- [ ] OpenAPI generation and drift checks pass.
- [ ] MCP schema drift check passes.
- [ ] Webhook payload coverage check passes.
- [ ] Security reporting process is visible.
