...
export interface paths {
    ...
    "/reporting/nl-query": {
        ...
        put?: never;
        /**
         * Natural-language telecom reporting
         * @description Compiles a bounded natural-language question into approved call reporting filters and returns matching call events with an explanation of the applied filters. Unsupported questions fail closed. Advisory only — never modifies data.
         */
        post: {
            parameters: {
                query?: never;
            ...
            responses: {
                /** @description Query result with applied filters and matching call events */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            data: components["schemas"]["NlQueryResult"];
                        };
                    };
                };
                default: components["responses"]["ErrorResponse"];
...
export interface components {
    schemas: {
        ...
        NlQueryResult: {
            question: string;
            applied_filters: components["schemas"]["ReportFilter"][];
            explanation: string;
            result_count: number;
            results: components["schemas"]["ReportCallRow"][];
            /** @enum {boolean} */
            is_advisory: true;
            /** Format: date-time */
            queried_at: string;
        ...
        CallFailureExplanation: {
            ...
            /** @enum {string} */
            unavailable_reason?: "no_events" | "not_failed";
            observed_facts: components["schemas"]["FailureFact"][];
            likely_cause: string;
            next_action: string;
            event_timeline: components["schemas"]["ExplainEventSummary"][];
            /** @enum {boolean} */
            is_advisory: true;
            /** Format: date-time */
            explained_at: string;
